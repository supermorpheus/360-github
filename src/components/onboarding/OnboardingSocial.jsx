...
function OnboardingSocial() {
  ...
  const handleChange = (e) => {
    ...
    updateProfileData({ [name]: cleanValue })
  }
    ...
    <OnboardingLayout>
      <div className="onboarding-form">
        <div className="form-header">
          <h1 className="form-title">Your social handles</h1>
          <p className="form-subtitle">Help members connect with you (optional)</p>
        </div>
        ...
        <p className="skip-note">These fields are optional. You can add them later.</p>
      </div>
    </OnboardingLayout>
  )
}
