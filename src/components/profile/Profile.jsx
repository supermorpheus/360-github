...
function Profile() {
  ...
  const lifeStories = currentUser.lifeStories || {}
    ...
    <>
      ...
      <div className="page-content my-profile-page">
        ...
        <div className="profile-name-photo-row">
          <div className="profile-name-info">
            ...
            <div className="profile-org-line">
              ...
              <span>{currentUser.currentOrganization}</span>
            </div>
          </div>
        ...
        <div className="profile-lives-in">
          ...
          <span className="lives-in-city">{currentUser.livesIn}</span>
        </div>
        ...
        {lifeStories.earlyLife && (
          <div className="life-story-section">
            ...
            {currentUser.videos?.earlyLife?.thumbnail && (
              <div className="story-video-thumbnail">
                <img src={currentUser.videos.earlyLife.thumbnail} alt="Early Life" />
        ...
        {lifeStories.professional && (
          <div className="life-story-section">
            ...
            {currentUser.videos?.professionalLife?.thumbnail && (
              <div className="story-video-thumbnail">
                <img src={currentUser.videos.professionalLife.thumbnail} alt="Professional Life" />
                <div className="video-play-btn">
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="white">
                    <polygon points="5 3 19 12 5 21 5 3" />
                  </svg>
