...
export const lifeStoryPrompts = {
  earlyLife: {
    ...
    icon: <img src={`${import.meta.env.BASE_URL}early life final.jpeg`} alt="Early Life" style={{ width: '48px', height: '48px', objectFit: 'cover', borderRadius: '10px' }} />,
    prompts: [
  ...
  professional: {
    ...
    icon: <img src={`${import.meta.env.BASE_URL}mid life final.jpeg`} alt="Mid Life" style={{ width: '48px', height: '48px', objectFit: 'cover', borderRadius: '10px' }} />,
  ...
  current: {
    ...
    icon: <img src={`${import.meta.env.BASE_URL}current life final.jpeg`} alt="Current Life" style={{ width: '48px', height: '48px', objectFit: 'cover', borderRadius: '10px' }} />,
    sections: [
      {
        title: 'Personal',
