...
export const lifeStoryPrompts = {
  earlyLife: {
    ...
    icon: <img src={`${import.meta.env.BASE_URL}early life final.jpeg`} alt="Early Life" style={{ width: '56px', height: '56px', objectFit: 'cover', objectPosition: 'center 48%', transform: 'scale(1.7)' }} />,
    prompts: [
  ...
  professional: {
    ...
    icon: <img src={`${import.meta.env.BASE_URL}mid life final.jpeg`} alt="Mid Life" style={{ width: '56px', height: '56px', objectFit: 'cover', objectPosition: 'center 48%', transform: 'scale(1.7)' }} />,
  ...
  current: {
    ...
    icon: <img src={`${import.meta.env.BASE_URL}current life final.jpeg`} alt="Current Life" style={{ width: '56px', height: '56px', objectFit: 'cover', objectPosition: 'center center', transform: 'scale(1.65)' }} />,
    sections: [
      {
        title: 'Personal',
